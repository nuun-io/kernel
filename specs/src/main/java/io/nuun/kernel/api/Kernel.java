...
public interface Kernel
{
    ...
    /**
     * Tell the kernel to start. Then the kernel will create the ObjectGraphProvider of the application. The ObjectGraphProvider will wrap the actual Guice injector.
     * <p>
    ...
    /**
     * After the kernel is started, one can ask the ObjectGraphProvider generated from the global module itself generated by all the modules the plugins create.
     * 
     * @return the ObjectGraphProvider
     */
    public abstract ObjectGraphProvider getObjectGraphProvider();
