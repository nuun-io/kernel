...
public abstract class ModuleAssertor
{
    ...
    protected <T >TimedLinkedBindingBuilder<T> assertBind(Wildcard wildcard)
    {
        GlobalHolder globalHolder = new GlobalHolder();
        globalHolders.add(globalHolder);
        ...
        return (TimedLinkedBindingBuilder<T>) new TimedLinkedBindingBuilderImpl<T>(globalHolder);
    }
