...
import io.nuun.kernel.tests.ut.fixtures.delta.ElementDelta;
 ...
 *
 */
public class ModuleAssertor
{
    private final Module actual;
    private final ElementMap<ElementAssertor> assertions;
  

    public ModuleAssertor ( Module actual , ElementMap<ElementAssertor> assertions)
    {
        this.actual = actual;
